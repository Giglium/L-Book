...
class showUser : public QDialog {
 ...
 public:
  explicit showUser(const QSharedPointer<account>, const QSharedPointer<loans>,
 ...
 private slots:
  ...
  void receiveUsername(const QSharedPointer<account>, const QString &,
                       const QString &);
  void receiveResult(const bool &);
