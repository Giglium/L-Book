...
public:
    book( const QString &, const QString &, const QString &, const QString &, const QString &, const QString ="", const QString ="", const QDate =QDate(), const QString ="", const QString ="", const unsigned int =0, const unsigned int =0, const unsigned int =0 );
    virtual ~book(){}
