...
int account_permission::showType() const { return type; }

int account_permission::showMaxLoan() const { return maxloan; }

int account_permission::showFreedomLoan() const { return maxloan - lockedloan; }

int account_permission::showLockedLoan() const { return lockedloan; }
