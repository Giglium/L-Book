...
class periodic : public publication {
 private:
  ...
  static QString toRoman(
      const unsigned int &); /* max int number to roman: 3999 */
  static unsigned int fromRoman(
      const QString &); /* max roman number to int: MMMCMXCIX */

 public:
  periodic(const QString &, const unsigned int &, const unsigned int &,
           const QString &, const QString &, const QString &, const QDate &,
           const QString = "", const QString = "");
  periodic(const QString &, const QString &, const unsigned int &,
           const QString &, const QString &, const QString &, const QDate &,
           const QString = "", const QString = "");
  virtual ~periodic() {}
