...
class loans {
 ...
 public:
  ...
  void addLoan(const QSharedPointer<account>, const QSharedPointer<publication>,
               const QDate &);
  void addLoan(const QSharedPointer<account>, const QSharedPointer<publication>,
               const int &);
  ...
  loans userLoans(
      const QString &) const; /* Work only with registration number */
  loans userLoans(const QSharedPointer<account>) const;
  loans publicationLoans(
      const QString &); /* Work only with Identification code */
  ...
  bool makeLoan(const QSharedPointer<account>,
                const QSharedPointer<publication>, const int &);
