...
publication_permission::publication_permission(const bool &variety,
...
void publication_permission::setType(const bool &variety) { type = variety; }
...
int publication_permission::showCopyNumber() const { return copynumber; }

int publication_permission::showFreedomCopy() const {
  return copynumber - lockedcopy;
}

int publication_permission::showLockedCopy() const { return lockedcopy; }
